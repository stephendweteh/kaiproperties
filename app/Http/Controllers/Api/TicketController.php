...
class TicketController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = Ticket::query()
            ->with(['property', 'category', 'reporter:id,name,email', 'technician:id,name,email', 'technicians:id,name,email'])
    ...
    public function store(TicketStoreRequest $request)
    {
        ...
        return response()->json([
            ...
            'data' => TicketResource::make($ticket->load(['property', 'category', 'reporter', 'technician', 'technicians'])),
        ], 201);
    }
